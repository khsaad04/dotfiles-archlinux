...
sleep 1
paru -Syu hyprland swww waybar-hyprland pamixer wofi foot fish starship dunst libnotify ttf-firacode-nerd catppuccin-gtk-theme-mocha papirus-icon-theme --needed --noconfirm && echo "installing packages complete"
sleep 1
